...
import argparse
parser = argparse.ArgumentParser(description='Cracks ROT-n Caesar Ciphers by a brute force attack on a sample of text\nWritten '
                                             'by Amith KK, [https://github.com/amithkk/caesar-salad]', formatter_class=argparse.RawDescriptionHelpFormatter)
...
words = [line.rstrip('\n').lower() for line in open('./words.txt')]
